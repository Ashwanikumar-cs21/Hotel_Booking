...
const Hero = () => {
  return (
    <div className='flex flex-col item-start justify-center px-6 md:px16 lg:px-14 xl:px32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
