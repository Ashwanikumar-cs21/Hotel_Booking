...
const RoomDetails = () => {
  ...
  return room && (
    ...
    <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-15 text-gray-500'>
    ...
    <button type='Submit' className='bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'> 
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests are allocated rooms on the ground floor based on availability. Enjoy a comfortable two-bedroom apartment with a true city vibe. The listed price is for two guests; please select the correct number of guests to view the accurate price for groups.</p>
      </div>
{/* posted by */}
